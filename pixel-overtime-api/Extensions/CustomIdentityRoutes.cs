...
namespace pixel_overtime_api.Extensions;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
            ...
            ([FromBody] LoginRequest login, [FromQuery] bool? useCookies, [FromQuery] bool? useSessionCookies, [FromServices] IServiceProvider sp) =>
        {
            ...
            //TODO: mettre en cache les token refresh pour pouvoir les révoquer au besoin
            ...
            ([FromServices] IServiceProvider sp) =>
        {
            ...
            //TODO: supprimer le token refresh en cache pour le révoquer

            return TypedResults.Ok();
        });

        routeGroup.MapPost("/refresh", async Task<Results<Ok, UnauthorizedHttpResult, SignInHttpResult, ChallengeHttpResult>>
            ([FromBody] RefreshRequest refreshRequest, [FromServices] IServiceProvider sp) =>
        {
            ...
            //TODO: Vérifier le token refresh en cache pour être sûr qu'il ne soit pas révoqué
